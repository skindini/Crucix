...
export { ClaudeCLIProvider } from "./claude-cli.mjs";
...
export function createLLMProvider(llmConfig) {
  ...
  switch (provider.toLowerCase()) {
    ...
    case "claude-cli":
    case "claude-max":
      // Subscription auth ONLY: the token is CLAUDE_CODE_OAUTH_TOKEN (read by the
      // provider itself). LLM_API_KEY is an API key — handing it over as the OAuth
      // token made the CLI answer "Not logged in" on every sweep (2026-09-01).
